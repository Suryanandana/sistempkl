                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="fw-bolder">Feedback</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $no=1; ?>
                                            <?php foreach ($data as $row): ?>
                                                        <tr id="baris<?= $no ?>">
                                                            ...
                                                            <td>
                                                                <?= $row->nilai_motivasi_industri ?>
                                                            </td>
                                                            <td>
                                                                <?= $row->nilai_kreativitas_industri ?>
                                                            </td>
                                                            <td>
                                                                <?= $row->nilai_disiplin_industri?>
                                                            </td>
                                                            <td>
                                                                <?= $row->nilai_pembahasan_industri ?>
                                                            </td>
                                                            <td>
                                                                <?= $row->feedback_industri ?>
                                                            </td>
                                                        </tr>
                                                        <?php $no++; ?>
                                            <?php endforeach; ?>
...
<div class="modal fade" tabindex="-1" id="kt_modal_1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('cpindustri/inputnilai'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label>Nilai Motivasi</label>
                            <input type="text" class="form-control" name="nilai_motivasi_industri" />
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-6">
                            <label>Nilai Kreativitas</label>
                            <input type="text" class="form-control" name="nilai_kreativitas_industri" />
                        </div>
                        <div class="col-6">
                            <label>Nilai Disiplin</label>
                            <input type="text" class="form-control" name="nilai_disiplin_industri" />
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-6">
                            <label>Nilai Pembahasan</label>
                            <input type="text" class="form-control" name="nilai_pembahasan_industri" />
                        </div>
                        <div class="col-6">
                            <label>Feedback</label>
                            <input type="text" class="form-control" name="feedback_industri" />
                        </div>
                    </div>
                </div>
